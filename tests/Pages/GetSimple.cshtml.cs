...
{
    public class GetSimpleModel : PageModel
    {
        private ILogger<GetSimpleModel> logger;
        private ICompositeViewEngine engine;

        public GetSimpleModel(ILogger<GetSimpleModel> logger, ICompositeViewEngine engine)
        {
            this.logger = logger;
            this.engine = engine;
        }
