...
{
    public class EditSimpleByPostWithAntiForgeryTokensModel : PageModel
    {
        private ILogger<EditSimpleByPostModel> logger;
        private ICompositeViewEngine engine;

        public EditSimpleByPostWithAntiForgeryTokensModel(ILogger<EditSimpleByPostModel> logger, ICompositeViewEngine engine)
        {
            this.logger = logger;
            this.engine = engine;
        }
