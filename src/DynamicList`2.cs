...
namespace DynamicVML
{
        ...
        where TOptions : DynamicListItem<TViewModel>, new()
    {
        ...
        /// </returns>
        ///
        public virtual TOptions this[string id] => Dictionary[id];
        ...
        /// </summary>
        ///
        /// <param name="viewModel">The view model object added to the list.</param>
        ///
        protected virtual void OnAdd(TViewModel viewModel)
        {
        }
        ...
        /// </summary>
        ///
        /// <param name="options">The options object added to the list.</param>
        ///
        protected virtual void OnAdd(TOptions options)
        {
        }
